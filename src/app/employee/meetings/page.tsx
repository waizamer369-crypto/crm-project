...
export default function MeetingRoom() {
  ...
  useEffect(() => {
    ...
    // Catch tab close / refresh / browser back — sendBeacon fires reliably even as the page unloads
    const handleUnload = () => {
    ...
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center text-white p-6">
      {joining ? (
        ...
        <div className="text-center max-w-sm">
          ...
          <Link href="/employee/meetings" className="text-blue-400 hover:underline">
            Back to Meetings
          </Link>
        </div>
      ) : (
